...
import { LayoutGrid, Package, Tag, ScrollText, Users, Star, ShoppingBag } from 'lucide-react';
          ...
          {[
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                ...
                (isActive ? 'bg-(--color-accent-soft) text-(--color-accent) font-semibold' : 'hover:bg-(--color-accent-soft)/50')
              }
            >
